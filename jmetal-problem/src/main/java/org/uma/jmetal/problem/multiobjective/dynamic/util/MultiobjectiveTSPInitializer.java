package org.uma.jmetal.problem.multiobjective.dynamic.util;
 ...
 */
public class MultiobjectiveTSPInitializer {

  public DynamicMultiobjectiveTSP initializeProblem(String distanceFileName, String costFileName) throws IOException {
    int         numberOfCities ;
